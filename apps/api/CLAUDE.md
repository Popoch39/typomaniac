...
- **Route** : `src/modules/duel/index.ts`, WebSocket `/api/duel` monté en dernier par `createApp`. La macro `auth` s'applique à l'upgrade : sans Session valide, 401 au format API et pas de connexion.
