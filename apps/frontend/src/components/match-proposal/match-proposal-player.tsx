...
type MatchProposalPlayerProps = {
  handle: string;
  image: string | null;
  // The Ornament the player wears around their avatar.
  ornament: Tier | null;
  rank: Rank | null;
  status: PlayerStatus;
...
// One of the two players of the Match proposal: avatar with their Ornament, Handle, rank and where
// they stand, their card ringed in the accent while it is their turn, in green once ready.
